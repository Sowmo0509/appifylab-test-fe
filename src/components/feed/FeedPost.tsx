...
export default function FeedPost({ post, onInteraction }: { post?: any; onInteraction?: () => void }) {
  return (
    <>
      <div className="_feed_inner_timeline_post_area _b_radious6 _padd_b24 _padd_t24 _mar_b16">
        <div className="_feed_inner_timeline_content _padd_r24 _padd_l24">
            ...
            <div className="_feed_inner_timeline_post_box">
              ...
              <div className="_feed_inner_timeline_post_box_txt">
                ...
                <p className="_feed_inner_timeline_post_box_para">
                  {new Date(post?.createdAt).toLocaleDateString()} .<a href="#0">{post?.visibility || "Public"}</a>
                </p>
              </div>
            </div>
          ...
          {post?.imageUrl && (
            <div className="_feed_inner_timeline_image">
              <Image src={post.imageUrl.startsWith("/") ? post.imageUrl : `/${post.imageUrl}`} alt="" className="_time_img" width={500} height={300} style={{ width: "100%", height: "auto" }} />
            </div>
          )}
        </div>
        <div className="_feed_inner_timeline_total_reacts _padd_r24 _padd_l24 _mar_b26">
          <div className="_feed_inner_timeline_total_reacts_image">
            ...
            <Image src="/assets/images/react_img3.png" alt="Image" className="_react_img _rect_img_mbl_none" width={100} height={100} />
            <Image src="/assets/images/react_img4.png" alt="Image" className="_react_img _rect_img_mbl_none" width={100} height={100} />
            <Image src="/assets/images/react_img5.png" alt="Image" className="_react_img _rect_img_mbl_none" width={100} height={100} />
