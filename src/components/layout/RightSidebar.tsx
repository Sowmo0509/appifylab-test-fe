										...
										<div className="_right_inner_area_info_ppl">
											<div className="_right_inner_area_info_box">
												<div className="_right_inner_area_info_box_image">
													<a href="profile.html">
														<Image src="/assets/images/Avatar.png" alt="Image" className="_ppl_img"width={100} height={100} />
													</a>
												</div>
									...
									<div className="_feed_right_inner_area_card  _padd_t24  _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
										...
										<div className="_feed_right_inner_area_card_ppl _feed_right_inner_area_card_ppl_inactive ">
											<div className="_feed_right_inner_area_card_ppl_box">
												<div className="_feed_right_inner_area_card_ppl_image">
													<a href="profile.html">
														<Image src="/assets/images/people1.png" alt="" className="_box_ppl_img"width={100} height={100} />
													</a>
												</div>
										...
										<div className="_feed_right_inner_area_card_ppl">
											<div className="_feed_right_inner_area_card_ppl_box">
												<div className="_feed_right_inner_area_card_ppl_image">
													<a href="profile.html">
														<Image src="/assets/images/people2.png" alt="" className="_box_ppl_img"width={100} height={100} />
													</a>
												</div>
												<div className="_feed_right_inner_area_card_ppl_txt">
													<a href="profile.html">
										...
										<div className="_feed_right_inner_area_card_ppl">
											<div className="_feed_right_inner_area_card_ppl_box">
												<div className="_feed_right_inner_area_card_ppl_image">
													<a href="profile.html">
														<Image src="/assets/images/people3.png" alt="" className="_box_ppl_img"width={100} height={100} />
													</a>
												</div>
												<div className="_feed_right_inner_area_card_ppl_txt">
													<a href="profile.html">
