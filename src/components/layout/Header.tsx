        ...
        <div className="container _custom_container">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
              ...
              <li className="nav-item _header_nav_item">
                <div id="_notify_btn" className="nav-link _header_nav_link _header_notify_btn" style={{ cursor: 'pointer' }}>
                      ...
                      <div className="_notifications_all">
                        <div className="_notification_box">
                          <div className="_notification_image">
                            <Image src="/assets/images/friend-req.png" alt="Image" className="_notify_img" width={100} height={100} />
                          </div>
                        ...
                        <div className="_notification_box">
                          <div className="_notification_image">
                            <Image src="/assets/images/profile-1.png" alt="Image" className="_notify_img" width={100} height={100} />
                          </div>
                          <div className="_notification_txt">
                            <p className="_notification_para">
            ...
            <div className="_header_nav_profile" ref={profileWrapRef}>
              {user ? (
                <>
                  <button
                    type="button"
                    className="_header_nav_profile_trigger"
                  ...
                  >
                    ...
                    <div className="_header_nav_dropdown">
                      <span className="_header_nav_para">{displayName}</span>
                      <span className="_header_nav_dropdown_btn _dropdown_toggle" aria-hidden>
                  ...
                  <div
                    ...
                    className={`_nav_profile_dropdown _profile_dropdown${profileMenuOpen ? ' show' : ''}`}
                  >
                    <div className="_nav_profile_dropdown_info">
                      ...
                      <div className="_nav_profile_dropdown_info_txt">
                        ...
                        <Link href="/profile" className="_nav_drop_profile" onClick={() => setProfileMenuOpen(false)}>
                          View Profile
                        </Link>
                      </div>
                    </div>
                    ...
                    <ul className="_nav_dropdown_list">
                      <li className="_nav_dropdown_list_item">
                        <Link href="/" className="_nav_dropdown_link" onClick={() => setProfileMenuOpen(false)}>
                      ...
                      <li className="_nav_dropdown_list_item">
                        <button type="button" className="_nav_dropdown_link _nav_dropdown_logout" role="menuitem" onClick={handleLogout}>
                          <div className="_nav_drop_info">
                            <span>
                              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="#377DFF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
